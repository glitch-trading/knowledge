...
## Why Read This
Foundation for understanding how all markets work — order types, order books, market making, adverse selection, spread economics. Required before touching the [[avellaneda-stoikov|Avellaneda-Stoikov]] paper.
...
## Connections
- Prerequisite for [[avellaneda-stoikov|Avellaneda-Stoikov]]
- Concepts used throughout [[market-structure-moc|Market Structure MOC]]
