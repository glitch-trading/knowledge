...
## Why Read This
Provides all the stochastic calculus needed for the [[avellaneda-stoikov|Avellaneda-Stoikov]] paper and beyond. Chapters 1-4 are essential.

## Reading Plan
- **Chapter 1:** General probability theory
- **Chapter 2:** Information and conditioning
- **Chapter 3:** [[brownian-motion|Brownian Motion]]
- **Chapter 4:** [[ito-calculus|Itô Calculus]] — the core chapter
...
- **Feynman-Kac connects expectations to PDEs.** Expected values of functions of diffusion processes satisfy PDEs. This is why the [[avellaneda-stoikov|Avellaneda-Stoikov]] optimization (maximize expected utility) becomes an [[hjb-equation|HJB Equation]].


## Connections
- Enables reading [[avellaneda-stoikov|Avellaneda-Stoikov]]
