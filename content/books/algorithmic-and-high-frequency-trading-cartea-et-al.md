...
## Why Read This
Takes the [[avellaneda-stoikov|Avellaneda-Stoikov]] framework and extends it significantly. Covers optimal execution algorithms, market impact modeling, and advanced market making. The academic reference for algorithmic trading.
...
## Connections
- Direct extension of [[avellaneda-stoikov|Avellaneda-Stoikov]]
- Covers [[twap|TWAP]], [[vwap|VWAP]], [[market-impact|Market Impact]] in depth
