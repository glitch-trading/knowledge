---
title: "Level 5 — Hands-On With Some Profit"
type: roadmap
level: 5
status: not-started
tags:
...
- Mean-variance optimization, efficient frontier, [[sharpe-ratio|Sharpe Ratio]]
...
Model: governance outcome → expected token impact → [[position-sizing|Position Sizing]].
...
- What's the Sharpe? Win rate? [[maximum-drawdown|Maximum Drawdown]]?
...
- Position size based on signal confidence using [[kelly-criterion|Kelly Criterion]] or fractional Kelly.
...
#### [[funding-rate-arbitrage|Funding Rate Arbitrage]] Harvesting Across Perp DEXs
...
## Unlocks
- [[level-6-advanced-topics|Level 6 — Advanced Topics]]
