...
- [[trading-bot-operations|Trading Bot Operations]] — end-to-end production checklist (ingestion, execution, OpSec, deployment, monitoring)
- [[paper-trading|Paper Trading]] — pre-live validation discipline and ongoing canary
- [[kill-switch|Kill Switch]] — automated halts on drawdown, loss streaks, stale data, behavioral divergence
