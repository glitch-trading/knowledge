...
**Diversification is the only free lunch in finance.** By combining assets with imperfect [[correlation|Correlation]], portfolio variance can be reduced below the variance of any individual asset. This is the core insight.
...
**Tangency portfolio (max [[sharpe-ratio|Sharpe Ratio]]):**
...
- [[quantitative-risk-management-mcneil-frey-and-embrechts|Quantitative Risk Management — McNeil, Frey & Embrechts]]

## Connections

- [[sharpe-ratio|Sharpe Ratio]] — The tangency portfolio maximizes Sharpe
- [[correlation|Correlation]] — The key input that makes diversification work
- [[variance|Variance]] — Portfolio variance depends on covariance structure, not just individual variances
- [[principal-component-analysis|Principal Component Analysis]] — Used to regularize the covariance matrix and reduce dimensionality
- [[capm|CAPM]] — Equilibrium consequence of universal mean-variance optimization
- [[fama-french-factor-model|Fama-French Factor Model]] — Multi-factor extension used in alpha attribution
