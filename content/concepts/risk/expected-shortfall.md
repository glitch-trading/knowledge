...
Expected Shortfall (ES), also called Conditional Value at Risk (CVaR), measures the average loss in the worst X% of scenarios. Where [[value-at-risk|Value at Risk]] tells you the threshold ("losses won't exceed $1M 95% of the time"), Expected Shortfall tells you what happens when they do ("in the worst 5% of cases, average loss is $2.3M").
...
- [[value-at-risk|Value at Risk]] — The weaker risk measure that ES improves upon
- [[fat-tails|Fat Tails]] — The distributional reality that makes ES essential
