...
Survivorship bias is one of the two canonical paths to a backtest that looks great and bleeds money live — the other is [[look-ahead-bias|Look-Ahead Bias]]. Unlike look-ahead bias (a logic bug), survivorship bias is a *data sourcing* bug, which makes it harder to spot because the code is correct.
...
- **Multiple testing** — running enough strategies guarantees survivor-strategies appear (see [[hypothesis-testing|Hypothesis Testing]] and [[overfitting|Overfitting]]).

## Resources

- [[advances-in-financial-machine-learning-lopez-de-prado|Advances in Financial Machine Learning — López de Prado]] — Chapter on backtest pitfalls
- [[fooled-by-randomness-nassim-taleb|Fooled by Randomness — Nassim Taleb]] — The non-technical articulation
- Brown, Goetzmann, Ibbotson & Ross (1992), "Survivorship Bias in Performance Studies" — The original quantification

## Connections

- [[look-ahead-bias|Look-Ahead Bias]] — The other canonical backtest-killer
- [[overfitting|Overfitting]] — Survivorship-biased data makes overfitting easier and harder to detect
- [[statistical-arbitrage|Statistical Arbitrage]] — Cross-sectional strategies are especially sensitive
- [[hypothesis-testing|Hypothesis Testing]] — Tests on survivorship-biased data have inflated false-discovery rates
