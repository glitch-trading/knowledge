...
Maximum drawdown is what actually kills strategies and traders in practice. While [[sharpe-ratio|Sharpe Ratio]] and other return metrics tell you about average behavior, MDD tells you about the worst experience.
...
**Rules of thumb:**
- Full [[kelly-criterion|Kelly Criterion]] typically produces ~50% max drawdown over long horizons
...
- [[position-sizing|Position Sizing]] — Proper sizing is the primary defense against catastrophic drawdowns
- [[sharpe-ratio|Sharpe Ratio]] — MDD captures what Sharpe misses: path-dependent risk
- [[kelly-criterion|Kelly Criterion]] — Kelly fraction directly determines expected drawdown magnitude
