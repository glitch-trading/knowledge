...
- In [[avellaneda-stoikov|Avellaneda-Stoikov]], the parameter $\gamma$ is the risk aversion coefficient. It directly appears in the [[reservation-price|Reservation Price]] formula: $r = s - q\gamma\sigma^2(T-t)$
...
For [[exponential-utility|Exponential Utility]] $U(x) = -e^{-\gamma x}$:
...
## Connections
- [[utility-theory|Utility Theory]] — risk aversion is a property of the utility function
- [[exponential-utility|Exponential Utility]] — the CARA utility function with constant risk aversion $\gamma$
- [[kelly-criterion|Kelly Criterion]] — log utility implies a specific level of risk aversion
