...
A result due to Grinold (1989) decomposing the [[information-ratio|Information Ratio]] of an active strategy into the per-forecast skill (the [[information-coefficient|Information Coefficient]]) and the number of independent forecasts made per period (breadth):
...
- **Be honest about IC.** Backtest IC inflated by feature search is the canonical input to a Fundamental Law calculation that fails out of sample. Apply multiple-testing corrections, see [[the-deflated-sharpe-ratio-bailey-and-lopez-de-prado|The Deflated Sharpe Ratio — Bailey & López de Prado]].
...
- [[information-coefficient|Information Coefficient]] — per-signal skill input
- [[information-ratio|Information Ratio]] — system-level output
- [[alpha-combination|Alpha Combination]] — the procedure for actually achieving the breadth the law promises
- [[sharpe-ratio|Sharpe Ratio]] — IR is a benchmark-relative cousin
- [[overfitting|Overfitting]] — the most common reason out-of-sample IR misses the Fundamental Law prediction
