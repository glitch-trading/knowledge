...
## Connections
- [[utility-theory|Utility Theory]] — exponential utility is a specific utility function
- [[risk-aversion|Risk Aversion]] — $\gamma$ is the constant absolute risk aversion parameter
- [[avellaneda-stoikov|Avellaneda-Stoikov]] — uses exponential utility to derive optimal quotes
