...
- **Behavioral.** Realized vs. backtest/paper divergence beyond tolerance (see [[paper-trading|Paper Trading]]); position size drifting from sizing model; cumulative exposure beyond stated risk budget.
...
- Paper-mode trigger logic is identical to live, so paper P&L curves show the same halts and you can tune thresholds before they cost money. See [[paper-trading|Paper Trading]].
...
- **Stale-data trading.** Without a staleness halt, a frozen feed lets the bot trade phantom prices. See [[trading-bot-operations|Trading Bot Operations]].
...
- [[maximum-drawdown|Maximum Drawdown]] — the metric most kill switches are sized against
- [[position-sizing|Position Sizing]] — kill-switch budget should be consistent with per-trade sizing
- [[trading-bot-operations|Trading Bot Operations]] — kill switch is one component of the production checklist
- [[paper-trading|Paper Trading]] — where trigger thresholds and recovery paths are tuned and tested
- [[trade-journaling|Trade Journaling]] — every kill-switch trigger is journaled as a process event
- [[trading-psychology|Trading Psychology]] — kill switches are operator-emotion-proof process discipline
- [[risk-management-moc|Risk Management MOC]] — sits alongside [[value-at-risk|Value at Risk]] / [[expected-shortfall|Expected Shortfall]] as a structural risk control
