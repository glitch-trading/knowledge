...
**Relation to [[sharpe-ratio|Sharpe Ratio]]:**
...
**Fundamental Law connection.** IR is the left-hand side of the [[fundamental-law-of-active-management|Fundamental Law of Active Management]]:

$$\mathrm{IR} \approx \mathrm{IC} \cdot \sqrt{\mathrm{BR}}$$

so improving IR requires either raising per-signal [[information-coefficient|Information Coefficient]] or increasing the breadth $\mathrm{BR}$ — the number of *independent* forecasts per period. This decomposition is the entire basis of multi-signal alpha programs: it is mathematically easier to find many weakly-predictive independent signals than one strongly-predictive one.
...
- **Inherits all Sharpe failure modes** — fat tails, non-normality, multiple-testing inflation. See [[the-deflated-sharpe-ratio-bailey-and-lopez-de-prado|The Deflated Sharpe Ratio — Bailey & López de Prado]].
...
- [[the-deflated-sharpe-ratio-bailey-and-lopez-de-prado|The Deflated Sharpe Ratio — Bailey & López de Prado]] — multiple-testing corrections apply to IR identically

## Connections

- [[sharpe-ratio|Sharpe Ratio]] — IR generalizes Sharpe to benchmark-relative performance
- [[fundamental-law-of-active-management|Fundamental Law of Active Management]] — decomposes IR into [[information-coefficient|Information Coefficient]] × $\sqrt{\text{breadth}}$
- [[information-coefficient|Information Coefficient]] — per-signal input
- [[alpha-combination|Alpha Combination]] — the engineering of high-IR systems from many low-IC signals
