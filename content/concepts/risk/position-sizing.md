...
- **[[kelly-criterion|Kelly Criterion]]**: Optimal fraction based on edge and odds — maximizes geometric growth
...
- [[kelly-criterion|Kelly Criterion]] — The theoretical foundation
- Van Tharp — *Trade Your Way to Financial Freedom* (position sizing focused)
- [[a-man-for-all-markets-ed-thorp|A Man for All Markets — Ed Thorp]]

## Connections

- [[kelly-criterion|Kelly Criterion]] — Theoretical optimal sizing framework
- [[maximum-drawdown|Maximum Drawdown]] — The constraint that makes position sizing necessary
- [[risk-aversion|Risk Aversion]] — Your sizing reflects your risk tolerance
