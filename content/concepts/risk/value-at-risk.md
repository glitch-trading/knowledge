...
3. **Nearly useless for crypto.** Crypto returns exhibit extreme [[fat-tails|Fat Tails]] — the 1% worst outcomes are far worse than any Gaussian model predicts. A VaR model calibrated to normal conditions fails spectacularly during crashes.
...
Use [[expected-shortfall|Expected Shortfall]] instead — it addresses most of these problems.
...
- [[quantitative-risk-management-mcneil-frey-and-embrechts|Quantitative Risk Management — McNeil, Frey & Embrechts]] — Rigorous treatment
- Jorion, P. — *Value at Risk* (the standard reference)

## Connections

- [[expected-shortfall|Expected Shortfall]] — The superior alternative that measures average tail loss
- [[normal-distribution|Normal Distribution]] — The assumption behind parametric VaR (and why it fails)
- [[fat-tails|Fat Tails]] — Why VaR breaks down for crypto and most real financial data
