...
**Core approaches:**
- **Mean reversion / pairs trading**: Two correlated assets diverge. Bet on convergence. Requires [[cointegration|Cointegration]] (not just correlation) to be robust.
...
- **[[overfitting|Overfitting]]**: The biggest enemy. Historical patterns that aren't real.
...
- [[algorithmic-trading-ernie-chan|Algorithmic Trading — Ernie Chan]] — Practical stat arb implementation
...
- [[cointegration|Cointegration]] — The statistical foundation for pairs trading / mean reversion
- [[funding-rate-arbitrage|Funding Rate Arbitrage]] — A specific stat arb strategy in crypto
- [[regression|Regression]] — Core tool for modeling statistical relationships
