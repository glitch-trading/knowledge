...
This is [[spatial-arbitrage|Spatial Arbitrage]] extended to the on-chain world, with blockchain-specific complications.
...
- [[spatial-arbitrage|Spatial Arbitrage]] — The general principle; cross-chain is a specific venue type
- [[cex-dex-arbitrage|CEX-DEX Arbitrage]] — Often combined: arb between a CEX and a DEX on a specific L2
