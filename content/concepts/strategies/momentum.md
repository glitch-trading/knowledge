...
- **It is the Carhart fourth factor** added to the [[fama-french-factor-model|Fama-French Factor Model]] in 1997, now standard in factor regressions.
...
- **Misclassification by [[survivorship-bias|Survivorship Bias]].** Backtests that exclude delisted names overweight the short leg's actual win rate.

## Resources

- [[returns-to-buying-winners-and-selling-losers-jegadeesh-and-titman|Returns to Buying Winners and Selling Losers — Jegadeesh & Titman]] — The founding paper
...
- [[returns-to-buying-winners-and-selling-losers-jegadeesh-and-titman|Returns to Buying Winners and Selling Losers — Jegadeesh & Titman]] — Founding empirical paper
- [[fama-french-factor-model|Fama-French Factor Model]] — Momentum is the Carhart fourth factor
- [[capm|CAPM]] — Momentum alpha persists after controlling for market beta
- [[statistical-arbitrage|Statistical Arbitrage]] — Momentum is one of the canonical [[statistical-arbitrage|stat-arb]] signals
- [[overfitting|Overfitting]] — Momentum is unusual in *not* being a likely overfit; the deflated Sharpe of momentum survives the multiple-testing correction
- [[position-sizing|Position Sizing]] — Drawdown management is the central practical challenge
