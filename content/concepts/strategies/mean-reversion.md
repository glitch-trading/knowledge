...
- **Fat tails**: a 3σ deviation is supposed to be rare; if returns are fat-tailed, 3σ events happen often enough to ruin a naive sizing model. See [[fat-tails|Fat Tails]].
...
**Z-score entry signal** (same as in [[statistical-arbitrage|Statistical Arbitrage]]):
...
- [[algorithmic-trading-ernie-chan|Algorithmic Trading — Ernie Chan]] — practical mean reversion implementation
- Avellaneda & Lee (2010) — "Statistical Arbitrage in the U.S. Equities Market"

## Connections

- [[statistical-arbitrage|Statistical Arbitrage]] — mean reversion is the dominant stat-arb engine
- [[cointegration|Cointegration]] — the property that makes a spread tradeable as mean-reverting
- [[stationarity|Stationarity]] — the underlying statistical requirement
- [[market-making|Market Making]] — quoting is mean reversion at the microstructure level
- [[funding-rate-arbitrage|Funding Rate Arbitrage]] — basis mean reversion in perpetual futures
- [[fat-tails|Fat Tails]] — the main reason mean reversion blows up when it does
