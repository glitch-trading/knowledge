...
- **[[cex-dex-arbitrage|CEX-DEX Arbitrage]]**: Most of MEV by dollar value. AMM prices lag CEX; arbitrageurs correct them.
- **[[sandwich-attack|Sandwich Attack]]**: Frontrun + backrun around a victim's swap.
- **[[liquidation-botting|Liquidation Botting]]**: Triggering undercollateralized DeFi positions.
- **[[backrunning|Backrunning]]**: Placing a transaction right after a large trade to capture reversion.
...
- [[frontrunning|Frontrunning]] — Classic MEV extraction via priority ordering
- [[backrunning|Backrunning]] — Less adversarial MEV, capturing post-trade reversion
- [[sandwich-attack|Sandwich Attack]] — The combination of frontrunning and backrunning
- [[cex-dex-arbitrage|CEX-DEX Arbitrage]] — The largest category of MEV by volume
- [[amm|AMM]] — Primary venue where MEV is extracted
- [[liquidation-botting|Liquidation Botting]] — MEV from triggering undercollateralized positions
