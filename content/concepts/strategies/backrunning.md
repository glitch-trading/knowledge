...
Backrunning is placing your transaction immediately after a large trade (or other state-changing transaction) to profit from the price displacement it creates. Unlike [[frontrunning|Frontrunning]], you don't trade before the victim — you trade after, capturing the reversion or arbitrage opportunity their trade creates.
...
- [[mev|MEV]] — Backrunning is a fundamental MEV strategy
- [[frontrunning|Frontrunning]] — The more adversarial counterpart to backrunning
- [[sandwich-attack|Sandwich Attack]] — Combines frontrunning and backrunning
- [[cex-dex-arbitrage|CEX-DEX Arbitrage]] — Most CEX-DEX arb is structured as backrunning
