...
level: 5
prerequisites:
  - "[[convex-optimization-boyd-and-vandenberghe|Convex Optimization — Boyd & Vandenberghe]]"
---
...
- [[combinatorial-prediction-markets|Combinatorial Prediction Markets]] — primary trading application: KL-projection onto the marginal polytope
- [[bregman-divergence|Bregman Divergence]] — the natural objective family Frank-Wolfe minimizes in prediction-market settings
- [[logarithmic-market-scoring-rule|Logarithmic Market Scoring Rule]] — log-sum-exp cost requires the barrier variant near boundaries
- [[kl-divergence|KL Divergence]] — the LMSR-induced divergence Frank-Wolfe is optimizing in practice
- [[convex-optimization-boyd-and-vandenberghe|Convex Optimization — Boyd & Vandenberghe]] — background reference
