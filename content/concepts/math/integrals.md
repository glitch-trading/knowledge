...
- [[derivatives|Derivatives]] — integration is the inverse of differentiation
- [[expected-value|Expected Value]] — expected values are computed via integration over densities
- [[probability-distributions|Probability Distributions]] — CDFs are integrals of PDFs
