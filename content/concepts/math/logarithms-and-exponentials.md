...
- [[exponential-utility|Exponential Utility]] — logarithmic utility as a special case
- [[taylor-series|Taylor Series]] — the exponential function has the cleanest Taylor expansion
- [[geometric-brownian-motion|Geometric Brownian Motion]] — solution involves exponentials
- [[normal-distribution|Normal Distribution]] — the PDF is built on $e^{-x^2}$
