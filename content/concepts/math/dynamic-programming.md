...
- The [[bellman-equation|Bellman Equation]] is the discrete-time DP recursion; the [[hjb-equation|HJB Equation]] is its continuous-time limit
...
## Connections
- [[bellman-equation|Bellman Equation]] — the formal recursive equation that DP produces
- [[hjb-equation|HJB Equation]] — the continuous-time version of the Bellman equation
- [[markov-property|Markov Property]] — DP requires that the future depends only on the current state, not the history
