...
## Connections
- [[stochastic-differential-equations|Stochastic Differential Equations]] — the stochastic side of the Feynman-Kac correspondence
- [[hjb-equation|HJB Equation]] — Feynman-Kac connects the HJB equation's PDE form to the stochastic optimization problem
- [[avellaneda-stoikov|Avellaneda-Stoikov]] — uses this correspondence to turn expected utility maximization into a solvable PDE
