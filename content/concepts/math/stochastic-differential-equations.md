...
## Connections
- [[ito-calculus|Itô Calculus]] — the calculus framework for working with SDEs
- [[brownian-motion|Brownian Motion]] — the source of randomness in SDEs
- [[hjb-equation|HJB Equation]] — the PDE you solve when optimizing a system governed by an SDE
