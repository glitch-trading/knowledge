...
- [[derivatives|Derivatives]] — the chain rule is the most important derivative rule
- [[itos-lemma|Itô's Lemma]] — the stochastic generalization of the chain rule, with a correction term
