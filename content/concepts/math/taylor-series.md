...
- [[derivatives|Derivatives]] — Taylor coefficients are built from successive derivatives
- [[avellaneda-stoikov|Avellaneda-Stoikov]] — asymptotic expansion of the value function uses Taylor series
- [[itos-lemma|Itô's Lemma]] — is a second-order Taylor expansion adapted for stochastic processes
