...
- [[Large Language Models in Quant Research]] — Foundational context for what each agent can do
- [[Retrieval-Augmented Generation]] — The standard memory layer for these systems
- Man Group blog posts on AlphaGPT and Alpha Assistant (publicly available)

## Connections

- [[AI in Trading MOC]] — Index of AI-in-quant concepts
- [[Large Language Models in Quant Research]] — Each agent is an LLM application
- [[Retrieval-Augmented Generation]] — Memory and research-history tool
- [[Overfitting]] — The throughput of agentic systems multiplies the multiple-testing problem
- [[Look-Ahead Bias]] — The agent harness must enforce point-in-time data access architecturally
