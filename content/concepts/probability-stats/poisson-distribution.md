...
- The Poisson distribution is the discrete counterpart of the [[exponential-distribution|Exponential Distribution]]: Poisson counts events, exponential measures gaps
...
- [[poisson-process|Poisson Process]] — the underlying process that generates Poisson-distributed counts
- [[exponential-distribution|Exponential Distribution]] — inter-arrival times between Poisson events
- [[avellaneda-stoikov|Avellaneda-Stoikov]] — Poisson order arrivals are a core modeling assumption
