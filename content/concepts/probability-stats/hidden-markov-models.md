...
- **Stationarity assumption.** Like any [[markov-chain|Markov Chain]], the HMM assumes time-homogeneous transitions. The same rolling-window discipline from [[regime-switching|Regime Switching]] applies.
...
- [[markov-chain|Markov Chain]] — the latent process inside an HMM is a Markov chain
- [[regime-switching|Regime Switching]] — the observable-state cousin of HMMs
- [[time-series-analysis|Time Series Analysis]] — broader methodological context
- [[maximum-drawdown|Maximum Drawdown]] / [[position-sizing|Position Sizing]] — natural consumers of soft regime probabilities
- [[trading-strategies-moc|Trading Strategies MOC]] — where HMM-driven strategies live
