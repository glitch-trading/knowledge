...
- **Trading edge**: A trade has positive expected value if $E[\text{P\&L}] > 0$. But expected value alone is not sufficient — you also need to consider [[variance|Variance]] and tail risk.
- **Kelly criterion**: The [[kelly-criterion|Kelly Criterion]] maximizes $E[\ln(W)]$, the expected log wealth. This turns out to maximize long-run geometric growth rate.
...
- [[variance|Variance]] — the second central moment, measures dispersion around the mean
- [[utility-theory|Utility Theory]] — rational agents maximize expected utility, not expected wealth
- [[kelly-criterion|Kelly Criterion]] — maximizes expected logarithmic growth
