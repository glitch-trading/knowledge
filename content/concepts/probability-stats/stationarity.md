...
**Why spreads can be stationary**: Even though two price series are each non-stationary, their difference (or a linear combination) may be stationary. This is [[cointegration|Cointegration]] — the foundation of pairs trading.
...
- **Cointegration testing**: The Engle-Granger procedure for [[cointegration|Cointegration]] tests whether the residuals of a regression between non-stationary series are stationary. If yes → cointegrated → tradeable spread.
...
- [[time-series-analysis|Time Series Analysis]] — Stationarity is the foundational assumption for time series methods
- [[cointegration|Cointegration]] — Non-stationary series whose linear combination is stationary
- [[arima|ARIMA]] — The "I" in ARIMA handles non-stationarity through differencing
- [[autocorrelation|Autocorrelation]] — Autocorrelation analysis is only valid for stationary series
