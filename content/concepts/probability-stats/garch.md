...
- [[time-series-analysis|Time Series Analysis]] — GARCH is the standard model for the variance equation in financial time series
- [[variance|Variance]] — GARCH models the conditional variance as a time-varying process
- [[arima|ARIMA]] — Often paired: ARIMA for the conditional mean, GARCH for the conditional variance
- [[stationarity|Stationarity]] — GARCH requires $\alpha + \beta < 1$ for variance stationarity
