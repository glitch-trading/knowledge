...
The same calculation done one buy at a time *is* the Glosten-Milgrom market-making model. Spread is the maker's compensation for being repeatedly Bayes-updated by informed flow — see [[adverse-selection|Adverse Selection]].
...
- [[conditional-probability|Conditional Probability]] — Bayes' theorem is derived from the definition of conditional probability
