...
- **VaR failures**: [[value-at-risk|Value at Risk]] under normality told banks they were safe before 2008. Fat tails meant the actual losses were multiples of what VaR predicted. [[expected-shortfall|Expected Shortfall]] partially addresses this but still depends on the tail model.
...
- [[power-law-distribution|Power Law Distribution]] — the mathematical model behind most fat-tailed phenomena
- [[normal-distribution|Normal Distribution]] — the baseline that fat tails deviate from
- [[value-at-risk|Value at Risk]] — risk metric that fails under fat tails
- [[expected-shortfall|Expected Shortfall]] — a tail-sensitive alternative to VaR
