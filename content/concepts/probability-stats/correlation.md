...
- **Pairs trading signal**: High correlation between two assets may suggest a statistical relationship worth trading, but [[cointegration|Cointegration]] is the proper test for mean-reverting spreads.
...
- [[regression|Regression]] — Regression quantifies the relationship that correlation identifies
- [[cointegration|Cointegration]] — A more robust concept than correlation for pairs trading
- [[portfolio-optimization|Portfolio Optimization]] — Correlation matrix is a key input to mean-variance optimization
- [[variance|Variance]] — Correlation interacts with variance to determine portfolio risk
