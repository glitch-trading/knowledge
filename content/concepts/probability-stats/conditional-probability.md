...
- [[bayes-theorem|Bayes' Theorem]] — uses conditional probability to invert the direction of conditioning
- [[markov-property|Markov Property]] — a conditional independence assumption that simplifies stochastic models
