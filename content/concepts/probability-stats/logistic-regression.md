...
- [[regression|Regression]] — Logistic regression extends linear regression to binary outcomes
- [[probability-distributions|Probability Distributions]] — The Bernoulli distribution underlies logistic regression
- [[time-series-analysis|Time Series Analysis]] — Logistic regression can incorporate lagged features for sequential prediction
