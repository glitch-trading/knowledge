...
- **Model identification**: ACF and PACF plots are used to determine the appropriate [[arima|ARIMA]] model order — a critical step in time series modeling.
...
- [[time-series-analysis|Time Series Analysis]] — Autocorrelation is the primary diagnostic tool for time series
- [[stationarity|Stationarity]] — Autocorrelation is only meaningful for stationary series
- [[arima|ARIMA]] — ACF/PACF patterns determine ARIMA model order
- [[variance|Variance]] — Autocorrelation affects variance estimation (Newey-West standard errors)
