...
- **Limitations**: Variance treats upside and downside deviations equally and may understate risk when returns have [[fat-tails|Fat Tails]]. Alternatives include semi-variance, VaR, and Expected Shortfall.
...
- [[expected-value|Expected Value]] — variance is the expected squared deviation from the mean
- [[normal-distribution|Normal Distribution]] — fully characterized by mean and variance
- [[sharpe-ratio|Sharpe Ratio]] — risk-adjusted returns use standard deviation as the risk measure
- [[fat-tails|Fat Tails]] — when variance alone understates true risk
