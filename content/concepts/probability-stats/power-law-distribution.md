...
- [[fat-tails|Fat Tails]] — power laws are the primary mechanism producing fat tails in financial data
- [[avellaneda-stoikov|Avellaneda-Stoikov]] — real order flow deviates from exponential assumptions toward power laws
