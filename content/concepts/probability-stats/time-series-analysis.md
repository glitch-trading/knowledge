...
**Core concepts:**
- **[[stationarity|Stationarity]]**: Are the statistical properties (mean, variance) constant over time? Most time series methods require stationarity.
- **[[autocorrelation|Autocorrelation]]**: Is the series correlated with its own past values? This is the basis of AR models and mean-reversion strategies.
...
- **Volatility clustering**: Big moves follow big moves ([[garch|GARCH]]). Returns may be uncorrelated, but squared returns are highly autocorrelated.

**Major model families:**
- **[[arima|ARIMA]]**: Models for level/return prediction. AR (past values predict future), I (differencing for stationarity), MA (past errors predict future).
- **[[garch|GARCH]]**: Models for volatility prediction. Captures the conditional heteroskedasticity in financial returns.
- **[[cointegration|Cointegration]]**: Models for spread prediction. Two non-stationary series whose linear combination is stationary.
...
- [[autocorrelation|Autocorrelation]] — The fundamental diagnostic tool for time series dependence
- [[stationarity|Stationarity]] — The critical assumption underlying most time series models
- [[arima|ARIMA]] — The workhorse model for stationary/differenced time series
- [[cointegration|Cointegration]] — Time series relationship between non-stationary series
- [[garch|GARCH]] — Time series model for volatility dynamics
