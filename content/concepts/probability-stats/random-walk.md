...
- **Scaled random walk**: Shrink step size and time step; in the limit, this becomes [[brownian-motion|Brownian Motion]]
...
- [[brownian-motion|Brownian Motion]] — the continuous-time limit of the random walk
- [[markov-property|Markov Property]] — random walks are Markov: the future depends only on the current position
