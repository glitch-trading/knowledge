...
The explicit solution (via [[itos-lemma|Itô's Lemma]]):
...
## Connections
- [[brownian-motion|Brownian Motion]] — GBM is the exponential of Brownian Motion with drift
- [[log-normal-distribution|Log-Normal Distribution]] — the distribution of S(t) under GBM
- [[ito-calculus|Itô Calculus]] — needed to solve the GBM SDE and get the σ²/2 correction
