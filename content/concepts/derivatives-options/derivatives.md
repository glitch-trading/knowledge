...
- [[chain-rule|Chain Rule]] — the most important derivative rule for composed functions
- [[itos-lemma|Itô's Lemma]] — the stochastic calculus analog of the chain rule, requires second derivatives
- [[taylor-series|Taylor Series]] — derivatives define the coefficients of polynomial approximations
