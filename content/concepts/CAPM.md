...
Statistical significance of $\hat\alpha$ is the canonical test of "does this asset / portfolio have an edge after controlling for the market?" — see [[Hypothesis Testing]].

**Treynor ratio** (return per unit of beta, the CAPM-natural analogue to [[Sharpe Ratio]]):
...
- [[Options, Futures, and Other Derivatives — John Hull]] — CAPM and APT chapters as standard reference
...
- [[Principal Component Analysis]] — PC1 of stock returns is the empirical analogue of the market factor
