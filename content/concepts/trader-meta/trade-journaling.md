...
- [[position-sizing|Position Sizing]] — sizing by setup grade requires per-setup expectancy data
- [[trading-psychology|Trading Psychology]] — emotional logging is the input to fixing process leaks
- [[overfitting|Overfitting]] — small per-setup samples invite the same overfitting risks as backtests
- [[sharpe-ratio|Sharpe Ratio]] / [[sortino-ratio|Sortino Ratio]] — journaled returns feed the metrics
