...
- The [[spread|Spread]] (best ask minus best bid) is directly observable from the order book
- [[market-making|Market Making]] involves placing limit orders on both sides of the book
- Order book depth determines [[liquidity|Liquidity]] — how much you can trade without moving the price
- In [[avellaneda-stoikov|Avellaneda-Stoikov]], the market maker's limit orders sit in the order book at distances $\delta^a$ and $\delta^b$ from the midprice
...
## Connections
- [[order-types|Order Types]] — market orders consume from the book; limit orders add to it
- [[spread|Spread]] — the gap between best bid and best ask in the book
- [[liquidity|Liquidity]] — determined by the depth and resilience of the order book
- [[market-making|Market Making]] — market makers are the primary providers of order book liquidity
