...
In crypto/DeFi, adverse selection is acute for [[amm|AMM]] liquidity providers: arbitrageurs are the informed traders who systematically extract value from LPs whenever prices move.
...
- [[market-making|Market Making]] — Adverse selection is the primary risk a market maker faces
- [[spread|Spread]] — Spread width is largely determined by adverse selection intensity
- [[inventory-risk|Inventory Risk]] — The other major market making risk, but adverse selection is often dominant
- [[impermanent-loss|Impermanent Loss]] — IL in AMMs is a form of adverse selection loss to arbitrageurs
