...
- **Execution algorithms exist to minimize it**: [[twap|TWAP]], [[vwap|VWAP]], and more sophisticated algorithms (Almgren-Chriss, IS) are all designed to optimally manage the urgency-impact tradeoff.
...
- [[liquidity|Liquidity]] — Market impact is inversely related to available liquidity
- [[twap|TWAP]] — Simplest algorithm for reducing market impact over time
- [[vwap|VWAP]] — Volume-weighted execution to align with natural liquidity
- [[slippage|Slippage]] — Market impact is the primary driver of slippage on large orders
- [[adverse-selection|Adverse Selection]] — Permanent impact reflects information content; market makers face it as adverse selection
