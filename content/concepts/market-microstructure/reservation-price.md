...
## Connections
- [[avellaneda-stoikov|Avellaneda-Stoikov]] — the reservation price is the key result of the model
- [[utility-theory|Utility Theory]] — derived from the indifference condition under expected utility
- [[inventory-risk|Inventory Risk]] — the reservation price is the mechanism for managing inventory risk
