...
- **[[triangular-arbitrage|Triangular Arbitrage]]** — three sequential trades in a cycle. A partial fill on leg 2 leaves you holding the intermediate currency at a possibly-now-worse rate.
- **[[cex-dex-arbitrage|CEX-DEX Arbitrage]]** — the CEX leg fills synchronously; the DEX leg sits in the mempool. Reorgs, gas spikes, or front-runs break the hedge.
...
- **[[funding-rate-arbitrage|Funding Rate Arbitrage]]** — perp leg fills; spot leg slips against you mid-fill.
...
- [[flash-boys-2-0-daian-et-al|Flash Boys 2.0 — Daian et al.]] — leg risk in the on-chain setting

## Connections

- [[spatial-arbitrage|Spatial Arbitrage]] / [[triangular-arbitrage|Triangular Arbitrage]] / [[cex-dex-arbitrage|CEX-DEX Arbitrage]] / [[cross-chain-arbitrage|Cross-Chain Arbitrage]] — concrete multi-leg strategies where leg risk dominates execution P&L
- [[combinatorial-prediction-markets|Combinatorial Prediction Markets]] — many-leg arbitrages on non-atomic venues
- [[funding-rate-arbitrage|Funding Rate Arbitrage]] — multi-leg basis trade
- [[slippage|Slippage]] / [[market-impact|Market Impact]] — the per-leg execution cost that leg risk amplifies
- [[mev|MEV]] / [[frontrunning|Frontrunning]] — adversarial leg-risk amplification on public mempools
- [[liquidity|Liquidity]] — the constraint that bounds capacity-adjusted profit
