...
- **Adverse-selection proxy for market makers.** Quoting passively when VPIN is elevated is exposing inventory to informed flow; tightening spreads is rational in low-VPIN regimes, widening (or stepping back) in high-VPIN regimes. Connects directly to [[adverse-selection|Adverse Selection]] in the [[avellaneda-stoikov|Avellaneda-Stoikov]] framework.
...
- **Microstructure feature for alpha signals.** Combined with effective spread, depth imbalance, and other order-flow features, VPIN is a standard component of short-horizon prediction stacks. See [[alpha-combination|Alpha Combination]].
...
- [[market-microstructure-theory-maureen-ohara|Market Microstructure Theory — Maureen O'Hara]]

## Connections

- [[adverse-selection|Adverse Selection]] — VPIN is a real-time estimator of adverse-selection intensity
- [[order-book|Order Book]] — VPIN consumes trade-tape data, complements L2 depth/imbalance features
- [[spread|Spread]] — effective spread and VPIN both proxy toxicity; useful as joint features
- [[avellaneda-stoikov|Avellaneda-Stoikov]] — quoting policy naturally widens / steps back as VPIN rises
- [[alpha-combination|Alpha Combination]] — VPIN is a microstructure-horizon signal in many combined alpha stacks
- [[market-making|Market Making]] — defensive use case for the metric
