...
- [[order-book|Order Book]] — Market Profile is the time-domain analogue of an L2 snapshot's volume distribution
- [[vwap|VWAP]] / [[twap|TWAP]] — related "fair price" anchors used by execution algos
- [[mean-reversion|Mean Reversion]] — POC and VA edges are common mean-reversion anchors
- [[liquidity|Liquidity]] — single prints mark thin, low-liquidity regions
