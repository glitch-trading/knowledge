...
- **Tightness**: how narrow the [[spread|Spread]] is (cost of a small trade)
...
- **Liquidity determines trading costs**: low liquidity means high [[slippage|Slippage]] and [[market-impact|Market Impact]], making strategies less profitable
...
- In [[avellaneda-stoikov|Avellaneda-Stoikov]], the fill rate parameter $k$ captures how frequently limit orders are hit — a proxy for how liquid the market is
...
## Connections
- [[order-book|Order Book]] — liquidity is determined by the state of the order book
- [[spread|Spread]] — the spread is the most direct measure of liquidity cost
- [[slippage|Slippage]] — consequence of insufficient liquidity for your order size
- [[market-impact|Market Impact]] — how your own trading reduces liquidity for subsequent trades
