...
- **Man Group — AlphaGPT.** Multi-agent system that generates strategy hypotheses, codes backtests, and critiques results — see [[multi-agent-systems-for-trading|Multi-Agent Systems for Trading]].
...
- **Look-ahead in generated code.** LLMs frequently produce backtest code that uses future information without flagging it — close-of-day features computed and traded at the same close, full-sample standardization, leaky cross-validation. See [[look-ahead-bias|Look-Ahead Bias]].
- **Survivorship in universe selection.** Asking an LLM to "give me the S&P 500 in 2010" produces today's constituents, not the actual point-in-time membership. See [[survivorship-bias|Survivorship Bias]].
...
- [[karpathy-neural-networks-zero-to-hero|Karpathy — Neural Networks Zero to Hero]] — Build a GPT from scratch; the right primer to know what's under the hood
- [[retrieval-augmented-generation|Retrieval-Augmented Generation]] — How to give an LLM access to your own data
- [[multi-agent-systems-for-trading|Multi-Agent Systems for Trading]] — How research-co-pilot use scales into AlphaGPT-style workflows

## Connections

- [[ai-in-trading-moc|AI in Trading MOC]] — Index of AI-in-quant concepts
- [[retrieval-augmented-generation|Retrieval-Augmented Generation]] — Standard pattern for grounding LLMs on private/financial data
- [[multi-agent-systems-for-trading|Multi-Agent Systems for Trading]] — Multi-LLM workflows that mimic research pods
- [[look-ahead-bias|Look-Ahead Bias]] / [[survivorship-bias|Survivorship Bias]] — The two failure modes LLM-generated backtest code most often introduces
