...
- [[large-language-models-in-quant-research|Large Language Models in Quant Research]] — Parent concept; RAG is the standard pattern for grounding LLMs on private data
- [[karpathy-neural-networks-zero-to-hero|Karpathy — Neural Networks Zero to Hero]] — Tokenizer and embedding episodes provide the foundations

## Connections

- [[ai-in-trading-moc|AI in Trading MOC]] — Index of AI-in-quant concepts
- [[large-language-models-in-quant-research|Large Language Models in Quant Research]] — Parent concept
- [[multi-agent-systems-for-trading|Multi-Agent Systems for Trading]] — Agents commonly use RAG as their "memory" tool
