...
- Returns are not eaten up by exposure to market beta or firm size — there is residual alpha after controlling for [[capm|CAPM]]-style factors.
...
- [[momentum|Momentum]] — The factor concept this paper established
- [[fama-french-factor-model|Fama-French Factor Model]] — Momentum is the canonical "fourth factor" later added (Carhart 1997)
- [[statistical-arbitrage|Statistical Arbitrage]] — Momentum is one of the canonical [[statistical-arbitrage|stat arb]] signals
- [[overfitting|Overfitting]] — Momentum is one of the few academic anomalies that has survived out-of-sample across decades and markets
- [[the-deflated-sharpe-ratio-bailey-and-lopez-de-prado|The Deflated Sharpe Ratio — Bailey & López de Prado]] — Useful counterweight: most "discovered" anomalies don't survive multiple-testing correction; momentum does
