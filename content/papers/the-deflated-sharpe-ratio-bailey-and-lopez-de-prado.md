...
The paper addresses a critical problem in quantitative finance: when you evaluate many strategies and select the one with the highest [[sharpe-ratio|Sharpe Ratio]], you're almost certainly selecting noise. The Deflated Sharpe Ratio (DSR) corrects the observed Sharpe for the number of trials conducted, the skewness and kurtosis of returns, and the length of the track record.
...
- [[sharpe-ratio|Sharpe Ratio]] — The metric being corrected
- [[overfitting|Overfitting]] — The problem DSR detects and quantifies
