...
- These [[fat-tails|Fat Tails]] mean extreme events are far more likely than Gaussian models predict
- Proper power-law analysis is essential for calibrating risk models like [[value-at-risk|Value at Risk]] and [[expected-shortfall|Expected Shortfall]]
...
- [[power-law-distribution|Power Law Distribution]] — The distribution this paper teaches you to properly identify
- [[fat-tails|Fat Tails]] — Power-law tails are the mechanism behind fat tails in financial data
