...
- [[impermanent-loss|Impermanent Loss]] — LPs systematically lose to informed arbitrageurs (see [[cex-dex-arbitrage|CEX-DEX Arbitrage]])
- No concentrated liquidity — fixed to v3

## Connections

- [[amm|AMM]] — Uniswap v2 is the canonical AMM implementation
- [[constant-product-formula|Constant Product Formula]] — The mathematical invariant underlying v2
